  ...
  return (
    <StyledAbout>
      <StyledDescription>
        ...
        <motion.p variants={fadeAnimation} style={{fontWeight: "bolder"}}>I am a full stack developer based in Peoria, Illinois. I am driven by delivering work that pleases both visually and functionally.</motion.p>
        <Link to="/contact">
